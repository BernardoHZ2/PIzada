...
<body>
  <div class="container">
    ...
    echo "<br><a href='index.php?inserir'>Inserir Laudo Médico</a>";
    echo "<br><br><a href='formulario.php?preencher'>Preencher Formulário</a>";
    ...
    <?php
      if (isset($_POST['gravar'])) {
        ...
        if ($_UP['tamanho'] <= $_FILES['arquivo']['size']) {
          echo "O arquivo ultrapassou o tamanho permitido.";
          echo "<br><br><a href='index.php?inserir'>Voltar</a>";
          exit();
        }
